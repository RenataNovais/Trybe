...
// verifica se a chamada mySum([1, 2, 3, 4]) retorna o valor 10
assert.deepStrictEqual(mySum([1, 2, 3, 4]), 10, "Resultado não encontrado");
// verifica se a chamada mySum([1, -2, -3, 4]) retorna o valor esperado
assert.deepStrictEqual(mySum([-1, -2, -3, -4]), -10, "Resultado não encontrado");
